...
<body>
  ...
  <script>
    ...
    function initStl() {
      ...
      var transversePlane = new THREE.Plane( new THREE.Vector3( 0, - 1, 0 ), 35 );
      ...
      stlloader.load( param +'/Model1.stl', function ( geometry ) {
        ...
        gui.add(visibilityControl, "visible").name( "Model Visible").onChange( function () {
          ...
          renderer.render( scene, camera );
                ...
                folderGlobal2.add( propsGlobal2, 'Plane', -20, 35 );
      ...
      ////////////////////////////////////////////////////////////////////////////////////////////////
      //display nrrd temporarily
      /*
      var loader = new THREE.NRRDLoader();
      //var nrrdPath = param +'/model.nrrd';
      var nrrdPath = param +'/mask.nrrd';
