...
<body>
  ...
  <script>
    ...
    function initStl() {
      ...
      var transversePlane = new THREE.Plane( new THREE.Vector3( 0, - 1, 0 ), 10 );
      var coronalPlane = new THREE.Plane( new THREE.Vector3( - 1, 0, 0 ), 10 );
			var sagittalPlane = new THREE.Plane( new THREE.Vector3( 0, 0, -1 ), 45 );
      ...
      stlloader.load( param +'/model1.stl', function ( geometry ) {
        ...
        gui.add(checkbox, 'check').name("Orthogonal").onChange(function(){
          console.log(checkbox.check)
          if(checkbox.check) {
            document.getElementById("screen1").style.display="block";
            document.getElementById("screen2").style.display="block";
            document.getElementById("screen3").style.display="block";
            document.getElementById("stl_model").style.bottom="0";
            document.getElementById("stl_model").style.right="20%";
            ...
            document.getElementById("stl_model").style.bottom="28%";
            document.getElementById("stl_model").style.right="25%";
        ...
        var folderLocal = gui.addFolder( 'Transverse Clipping' ),
              ...
              renderer.localClippingEnabled = v
					...
					folderGlobal = gui.addFolder( 'Coronal Clipping' ),
					propsGlobal = {
						get 'Plane'() {
          ...
          propsGlobal1 = {
              ...
              renderer.clippingPlanes = v ? globalPlanes1 : Empty;
				...
				folderLocal.add( propsLocal, 'Plane', -20, 10 );

				// folderGlobal.add( propsGlobal, 'Enabled' );
        folderGlobal.add( propsGlobal, 'Plane', - 20, 10 );
				folderGlobal1.add( propsGlobal1, 'Plane', 0, 45 );
      ...
      stlloader.load(param +'/model3.stl',function(geometry){
